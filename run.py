...
def play_bg_music():
    playsound.playsound("C:/Users/shalo/Desktop/Christmas-Wishing-Project-Python/system-files/bg-sound.mp3")

def finish_music():
    playsound.playsound("C:/Users/shalo/Desktop/Christmas-Wishing-Project-Python/system-files/finish-sound.mp3")
...
turtle_pen.speed(5)
turtle_pen.penup()
msg = "Wishing You A Very Merry Christmas ~ Shalomshan Selvakumar"
